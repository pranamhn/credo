          ...
          {pnlReport ? (
            ...
            <div className="py-14 text-center">
              ...
              <button
                ...
                className="mt-5 inline-flex items-center justify-center gap-2 rounded-lg bg-violet-600 px-4 py-2 text-xs font-semibold text-white shadow-sm transition-all hover:bg-violet-700 disabled:opacity-60"
              >
