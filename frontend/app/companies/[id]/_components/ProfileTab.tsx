      ...
      <div className="grid gap-4 md:grid-cols-2">
        <label className="block space-y-1.5 md:col-span-2">
          ...
          <textarea
            ...
            className="w-full resize-none rounded-lg border border-slate-200 px-3 py-2 text-xs text-slate-700 outline-none transition-all placeholder:text-slate-300 focus:border-teal-400 focus:ring-2 focus:ring-teal-500/10"
          />
        </label>
        {[
          ...
          <label key={key} className="block space-y-1.5">
            ...
            <input
              ...
              className="w-full rounded-lg border border-slate-200 px-3 py-2 text-xs text-slate-700 outline-none transition-all placeholder:text-slate-300 focus:border-teal-400 focus:ring-2 focus:ring-teal-500/10"
            />
          </label>
        ))}
        <label className="block space-y-1.5">
          ...
          <select
            ...
            className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-700 outline-none transition-all focus:border-teal-400 focus:ring-2 focus:ring-teal-500/10"
          >
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-4">
        ...
        <div className="grid gap-3 sm:grid-cols-3">
          {([
            ...
            return (
              <div key={key} className={`rounded-lg border p-3 transition-all ${ref ? "border-teal-200 bg-teal-50/40" : "border-slate-200 bg-slate-50/40"}`}>
                ...
                {ref ? (
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-1.5 min-w-0">
                      <FileText className="h-3 w-3 shrink-0 text-teal-600" />
                      <span className="text-[11px] font-medium text-teal-700 truncate" title={ref.filename}>{ref.filename}</span>
                    </div>
                    <div className="flex items-center gap-1">
                      <label className="cursor-pointer">
                        ...
                        />
                        <span className="inline-flex items-center gap-1 px-2 py-1 rounded text-[10px] font-medium text-slate-500 hover:text-teal-600 hover:bg-teal-50 transition-colors cursor-pointer">
          ...
          {[
            ...
            <div key={nameKey} className="space-y-2">
              ...
              <input
                ...
                placeholder="Nama"
                className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-700 outline-none transition-all placeholder:text-slate-300 focus:border-teal-400"
              />
              <input
                type="date"
                ...
                className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs text-slate-700 outline-none transition-all focus:border-teal-400"
              />
            </div>
          ))}
        </div>
